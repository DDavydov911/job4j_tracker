...
public class MathCalculator {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Сумма разности 20 и 10 и деления 20 на 10 равна: " + sumOfDiffAndDiv(20, 10));
        System.out.println("Сумма результатов четырех методов для 30 и 10 равна: " + sumOfAllMethodsResults(30, 10));
    }
}
